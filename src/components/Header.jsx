...
function openWhatsapp() {
    window.open('https://wa.me/393665036732?text=Ciao%20ti%20contatto%20per%20la%20bodyhack%20experience', '_blank')
}

function Header() {
  return (
    <div className="flex items-center justify-between w-full bg-gray-500/30 px-5 xl:px-10 py-4 rounded-full">
        <div>
        ...
        <div>
            <button onClick={() => openWhatsapp()} className="rounded-full bg-fuchsia-500 px-5 py-4 text-sm text-white">CONTATTACI ORA</button>
        </div>
    </div>
  )
}
